...
namespace VkUtils
{
	...
	{
		uint64_t bufferSize = sizeof(EngineCore::Vertex) * vertices.size();
	...
	VkVertexInputBindingDescription GetVertexInputBindingDescription()
	{
		...
		bindingDescription.stride = sizeof(EngineCore::Vertex);
	...
	std::array<VkVertexInputAttributeDescription, 4> GetVertexInputAttributeDescriptions()
	{
		...
		attributeDescriptions[0].offset = offsetof(EngineCore::Vertex, position);

		attributeDescriptions[1].binding = 0;
		attributeDescriptions[1].location = 1;
		attributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;
		attributeDescriptions[1].offset = offsetof(EngineCore::Vertex, normal);

		attributeDescriptions[2].binding = 0;
		attributeDescriptions[2].location = 2;
		attributeDescriptions[2].format = VK_FORMAT_R32G32_SFLOAT;
		attributeDescriptions[2].offset = offsetof(EngineCore::Vertex, uv);

		attributeDescriptions[3].binding = 0;
		attributeDescriptions[3].location = 3;
		attributeDescriptions[3].format = VK_FORMAT_R32G32B32_SFLOAT;
		attributeDescriptions[3].offset = offsetof(EngineCore::Vertex, color);
