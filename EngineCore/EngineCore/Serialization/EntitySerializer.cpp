...
namespace EngineCore
{
	...
	YAML::Emitter& operator<<(YAML::Emitter& out, const std::vector<glm::vec3>& v)
	{
		out << YAML::Flow;
		out << YAML::BeginSeq;
		for(int i = 0; i < v.size(); i++) out << v.at(i);
		out << YAML::EndSeq;
		return out;
	}
	...
	bool EntitySerializer::InstantiateWorld(const Ref<Ecs>& ecs, const std::filesystem::path& filePath) const
	{
		...
		//todo: handle a case when one of prefabs failed to instantiate
		for (auto& node : data) 
	...
	{
		if (entity->HasComponent<NotSerializableEntityComponent>()) return;
	...
	bool EntitySerializer::InstantiatePrefab(const Ref<Ecs>& ecs, const std::filesystem::path& filePath) const
	{
		YAML::Node data;
	...
	bool EntitySerializer::InstantiatePrefab(const Ref<Ecs>& ecs, YAML::Node& node) const
	{
		...
		InstantiateComponentShadowMap(entity, node);
		onInstantiateClientEntities(entity, node);

		return true;
	}

	void EntitySerializer::InstantiateCombinedMesh(const Ref<Ecs>& ecs, const std::filesystem::path& filePath) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const NameComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const PositionComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const RotationComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const RotationVelocityComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const ScaleComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const CameraComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const MeshComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const MaterialComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, UboModelComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, UboWorldComponent& component) const
	{
	...
	void EntitySerializer::SerializeComponent(YAML::Emitter& out, IdComponent& component) const
	{
		//don't need to serialize, because ID is unique only inside 1 session
	}

	void EntitySerializer::SerializeComponent(YAML::Emitter& out, const ShadowMapComponent& component) const
	{
	...
	void EntitySerializer::InstantiateComponentShadowMap(const Ref<Entity>& entity, YAML::Node node) const
	{
