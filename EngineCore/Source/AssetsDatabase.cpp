...
void AssetsDatabase::FillMeshesPaths()
{
	...
	IOUtility().FindResourcesFiles(projectSettings->projectPath + "Resources", relevantExtensions, meshesPaths);
}
...
void AssetsDatabase::FillTexturesPaths()
{
	...
	IOUtility().FindResourcesFiles(projectSettings->projectPath + "Resources", relevantExtensions, texturesPaths);
}
