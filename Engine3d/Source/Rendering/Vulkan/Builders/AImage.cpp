...
namespace AVulkan
{
        ...
        VkMemoryPropertyFlags properties, VkDeviceMemory& imageMemory) const
    {
        ...
        allocInfo.memoryTypeIndex = VkExtensions::FindMemoryType(physicalDevice, memRequirements.memoryTypeBits, properties);
    ...
    {
        auto commandBuffer = VkExtensions::BeginCommandBuffer(logicalDevice, commandPool);
        ...
        VkExtensions::SubmitCommandBuffer(graphicsQueue, commandBuffer);
