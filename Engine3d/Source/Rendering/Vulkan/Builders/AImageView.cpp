...
namespace AVulkan
{
	...
	void AImageView::Create(VkDevice& logicalDevice, Ref<SwapChainData> swapChainData) const
	{
	...
	void AImageView::Dispose(VkDevice& logicalDevice, Ref<SwapChainData> swapChainData) const
	{
