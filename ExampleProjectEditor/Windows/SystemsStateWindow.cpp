...
/// </summary>
UserEditor::SystemsStateWindow::SystemsStateWindow(const Ref<SystemsState>& systemsState) : systemsState(systemsState) { } 

void UserEditor::SystemsStateWindow::Update()
{
